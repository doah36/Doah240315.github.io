...
Hello! I hope your day is going well for you.

There isn't much here yet, but follow along as I develop on this workspace!
...
Financial inclusivity and risk management are at the heart of modern banking practices. (TBC)

###Basic Demographic Statistics of Customers


###Relationship between coverage amount, income level and policy type

###Comparison of Behavioral Policy Classification and Actual Insurance Products Owned

###Distribution of Premium amounts by segmentation group

```{=html}
<iframe height="400" width="100%" frameborder="no" src="https://doah240315.shinyapps.io/personal_app/"> </iframe>
```
